"""
Solución al proyecto final planteado por el sitio Web del curso 
Edube Interactive OpenEDG (https://edube.org).
"""
...
display = tk.Entry(
    window, width=10, font=("Courier New", "15", "bold"), textvariable=display_str, justify=tk.RIGHT
)
